...
import 'package:mobilepaymentapp/screens/notification.dart';
import 'package:mobilepaymentapp/screens/profile.dart';
import 'package:mobilepaymentapp/screens/recived.dart';

import '../widgets/amount_box.dart';
import '../widgets/large_box.dart';
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        "Search Uer's Id ",
                        style: TextStyle(color: Color(0xffB0BEC5CC)),
                      ),
                      SizedBox(
                        width: 10,
                      ),
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Notificationpg()));
                  },
                  child: Padding(
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Image(
                          image:
                              AssetImage('assets/images/collect_reward.png')),
                    ),
                  ],
                ),
                Padding(
